...
ln -fsr $BAM_MT $BAM_MT_TMP
ln -fsr $BAM_MT.bas $BAM_MT_TMP.bas
ln -fsr $IDX_MT $IDX_MT_TMP
ln -fsr $BAM_WT $BAM_WT_TMP
ln -fsr $BAM_WT.bas $BAM_WT_TMP.bas
ln -fsr $IDX_WT $IDX_WT_TMP
