...
include { sangerWxsVariantCaller; getSangerWxsSecondaryFiles } from '../sanger-wxs-variant-caller' params(params)
...
workflow {
  ...
  publish:
    sangerWxsVariantCaller.out to: "outdir", overwrite: true
}
