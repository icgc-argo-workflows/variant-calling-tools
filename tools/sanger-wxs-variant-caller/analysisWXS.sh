...
ln -rfs $BAM_MT $BAM_MT_TMP
ln -rfs $IDX_MT $IDX_MT_TMP
ln -rfs $BAM_WT $BAM_WT_TMP
ln -rfs $IDX_WT $IDX_WT_TMP
...
if [ ! -f "${BAM_MT}.bas" ]; then
  ...
  ln -rfs $BAM_MT.bas $BAM_MT_TMP.bas
fi
...
if [ ! -f "${BAM_WT}.bas" ]; then
  ...
  ln -rfs $BAM_WT.bas $BAM_WT_TMP.bas
fi
